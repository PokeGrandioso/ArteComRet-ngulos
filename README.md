### Pintando com Retângulos | Drawing with Rectangles

BR: Primeiro projeto que fiz no p5.js pelas aulas do Alura (Javascript)
EN: First project i build using P5.Js guided by Alura's classes
